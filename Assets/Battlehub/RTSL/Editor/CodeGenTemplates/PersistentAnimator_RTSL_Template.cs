...
{
    using PersistentAvatar = PersistentSurrogateTemplate;
    ...
    public class PersistentAnimator_RTSL_Template : PersistentSurrogateTemplate
    {
        ...
        public long avatar; //refrence to avatar from asset library

        [ProtoMember(1)]    //data of avatar created at runtime
        public PersistentAvatar animatorAvatar;
        ...
        public override void ReadFrom(object obj)
        {
            ...
            if (!m_assetDB.IsMapped(avatar))
            {
                animatorAvatar = new PersistentAvatar();
