...
{
    using PersistentHumanDescription = PersistentSurrogateTemplate;
    ...
    public class PersistentAvatar_RTSL_Template : PersistentSurrogateTemplate
    {
        ...
        [ProtoMember(2)]
        public PersistentHumanDescription humanDescription;
        ...
        public override void ReadFrom(object obj)
        {
            ...
            isHuman = uo.isHuman;
            humanDescription = new PersistentHumanDescription();
